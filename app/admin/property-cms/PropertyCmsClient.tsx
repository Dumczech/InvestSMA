    ...
    <div className='mt-6 grid gap-6 md:grid-cols-[300px_1fr]'>
      <aside className='space-y-2'>
        <div className='flex items-center justify-between'>
          <div className='text-xs uppercase tracking-wide text-white/50'>Properties</div>
          <Button variant='ghost' onClick={startNew}>+ New</Button>
        </div>
        {rows.length === 0 && (
          <div className='text-sm text-white/50'>No properties yet — click <em>New</em>.</div>
        )}
            ...
            <li key={r.slug}>
              ...
              >
                <span className='truncate'>
                  ...
                  <span className='block text-xs text-white/50'>{r.slug}</span>
                </span>
